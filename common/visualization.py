...
def visualize(model, grid_features, text_field, device):
    ...
    with torch.no_grad():
        ...
        out, _ = model.beam_search(grid_features, 50, text_field.vocab.stoi['<eos>'], 5, out_size=1)
...
def get_features_by_id(image_id, max_detections=50):
    clip_path = '/home/public/caption/caption/coco2014/feats/COCO2014_RN50x16_GLOBAL.hdf5'
