...
def train(args, clip_model, model, datasets, image_field, text_field, optim=None, scheduler=None, 
    ...
    for e in range(start_epoch, start_epoch + 100):
        if not use_rl:
            train_loss = train_xe_fn(clip_model, model, dataloader_train, optim, loss_fn, text_field, e, device, scheduler, args)
        ...
        # Validation loss
        val_loss = evaluate_loss_fn(clip_model, model, dataloader_val, loss_fn, text_field, e, device, args)
        ...
        # if patience == 5:
        #     if e < 15:   # xe stage train 15 epoches at least 
        #         use_rl = False
        #         switch_to_rl = False
        #         patience = 0
        #     elif not use_rl:
        ...
        # if e == 20:     # xe stage no more than 20 epoches
        #     if not use_rl:
        #         use_rl = True
        #         switch_to_rl = True
        #         patience = 0
